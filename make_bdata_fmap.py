...
bids_dir = '/bucket/DoyaU/Shuhei/cat_fox/fMRI/heudiconv/BIDS_decoding'

# The output bdata will be saved here.

output_dir = '/flash/DoyaU/shuhei/bdata_decoding/test'
...
roi_mask_native_dir = '/bucket/DoyaU/Shuhei/decoding_visual/training_stimulus/DIHM/DI171102/spm/roi'
roi_mask_standard_dir = '/bucket/DoyaU/Shuhei/decoding_visual/ROI_standard'
roi_mask_native_resampled_dir = '/bucket/DoyaU/Shuhei/decoding_visual/training_stimulus/DIHM/DI171102/spm/roi'
roi_label_surface_dir = '/bucket/DoyaU/Shuhei/decoding_visual/training_stimulus/DIHM/DI171102/spm/roi/freesurfer_dkt40'
...
# The example mapping file can be found at
# <https://gist.github.com/ShuntaroAoki/eeeaf45ba7ddf245fdf8e066227ffeee>.
#

# label_mapper = {'stimulus_name' : '/bucket/DoyaU/Shuhei/decoding_visual/label_mapping.csv'}
label_mapper = {'stimulus_name' : '/bucket/DoyaU/Shuhei/decoding_visual/label_mapping_test.csv'}
...
for output_data_type in output_data_type_list:
    ...
    bdata_list, data_labels = create_bdata_fmriprep(bids_dir,
                                                    ...
                                                    fmriprep_dir='/bucket/DoyaU/Shuhei/cat_fox/fMRI',
